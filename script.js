document.addEventListener('DOMContentLoaded', () => {
    ...
    // --- MAQUINA DE ESCRIBIR ---
    const welcomeMsg = "Flirty, sweet, charming, dreamy, thoughtful, cheerful, passionate, loyal yet toxic, whimsical, moody, so hate me or love me..";
    ...
    const galleryItems = [
        ...
        { 
            type: 'special-gif', 
            src: 'https://media.tenor.com/GAkvvUQi8jAAAAAm/pho.webp',  // Asegúrate de que este archivo exista
            title: 'Amor...', 
        ...
        { type: 'image', src: "https://media.tenor.com/J63bVPkM9-kAAAAM/cute-anime.gif" },
        { type: 'image', src: "https://media.tenor.com/A9DT93wnCP8AAAAM/kamome-kashima.gif" },
    ];
